package com.olmlo.thread.synchronize.app1;

import java.util.concurrent.TimeUnit;

/**
 * 
 * This class simulates a control class that stores the statistics of access to a building, controlling the number of
