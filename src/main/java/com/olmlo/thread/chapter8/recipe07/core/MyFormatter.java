...
/**
 * This class is used to format the log messages. The Logger class call the format() method to get the formatted log
 * message that it's going to write. The format method receives a LogRecord object as parameter. That object has all the
