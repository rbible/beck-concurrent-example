...
/**
 * This class is used to create a Logger object with the configuration you want. In this case, you're going to write all
 * the log messages generated in the application to the recipe8.log file and with the format specified in the
 * MyFormatter class. It uses the Logger class to create the Logger object. This class creates a Logger object per name
