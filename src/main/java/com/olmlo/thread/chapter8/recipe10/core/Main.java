package com.olmlo.thread.chapter8.recipe10.core;
...
public class Main {
    ...
    public static void main(String args[]) throws Exception {
         ...
         * System.out.println("Core: The example is running"); try {
         * TimeUnit.MILLISECONDS.sleep(500); } catch (InterruptedException ex) {
         * ex.printStackTrace(); } } */
    }
}
