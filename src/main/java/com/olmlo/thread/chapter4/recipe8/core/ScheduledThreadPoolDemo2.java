package com.olmlo.thread.chapter4.recipe8.core;
...
public class ScheduledThreadPoolDemo2{
    ...
    public static void main(String[] args) {
        ...
        ScheduledThreadPoolTask2 task = new ScheduledThreadPoolTask2("Task");
...
class ScheduledThreadPoolTask2 implements Runnable {
     ...
     */
    public ScheduledThreadPoolTask2(String name) {
        this.name = name;
    }
