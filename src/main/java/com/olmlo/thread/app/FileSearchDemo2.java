...
public class FileSearchDemo2 {
    ...
    public static void main(String[] args) {
        ...
        FileSearch2 system = new FileSearch2("C:\\Windows", "log", phaser);
        FileSearch2 apps = new FileSearch2("C:\\Program Files", "log", phaser);
        FileSearch2 documents = new FileSearch2("C:\\Documents And Settings", "log", phaser);
